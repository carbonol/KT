...
# Parámetros de verificación del modelo BKT: Tercera prueba empírica para el programa de ejercicios de sumas - Para hallar pR
p_l_max = 0.99
max_iterations = 1100
p_l_precision = 4

pl_boundary = wbkt_model.find_pl_boundary_where_pl_cannot_decrease_with_wrong_answers(p_l_max, 
        max_iterations, p_l_precision)
print(pl_boundary)

# print( (0.011434820225164358 + 0.5) / 2 )